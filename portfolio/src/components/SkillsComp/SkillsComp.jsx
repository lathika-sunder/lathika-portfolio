...
import reactflow from "../../assets/icons/react-flow.png";
...
import { FaCss3Alt, FaGit, FaGitAlt, FaGithub, FaHtml5, FaJava, FaNodeJs, FaPython } from "react-icons/fa";
      ...
      <div className="skills-grid">
        <div className="column">
          <div className="skills-card">
            <h2>Frontend</h2>
            <FaHtml5 className="tech-icon" size={64}/>
            ...
            <img className="tech-icon" src={figma} alt="Figma Icon" />
            <img className="tech-icon" src={reactflow} alt="React flow Icon" />
        ...
        <div className="column">
          ...
          <div className="skills-card">
            ...
            <FaJava className="tech-icon"/>
             <IoLogoJavascript color="yellow" className="tech-icon" size={64}/>
            <FaPython className="tech-icon" src={html}  />
